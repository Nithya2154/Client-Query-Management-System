...
1. Authentication
2. Login page with username, password, and role selection
3. Passwords validated using SHA-256 hashing
4. Session-based navigation using Streamlit session state
